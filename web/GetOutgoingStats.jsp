...
<%
    ArrayList<com.telzar.Data.OutGoingStats> OutGoingStats = new ArrayList<com.telzar.Data.OutGoingStats>();
    ArrayList<String> CountryOrder = new ArrayList<String>();
    
    while(rs.next()){
        OutGoingStats.add(new com.telzar.Data.OutGoingStats(rs));
        if(!CountryOrder.contains(rs.getString("country_name")))
              CountryOrder.add(rs.getString("country_name"));
    }
    
    ArrayList<com.telzar.Data.OutGoingStats> OrderedOutGoingStats = new ArrayList<com.telzar.Data.OutGoingStats>();
