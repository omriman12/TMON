...
//    com.telzar.Data.JsonTool.GenerateJSON(rs, out, "\n\n");
    
    /*
    ArrayList<com.telzar.Data.IncomeStats> IncomeStats = new ArrayList<com.telzar.Data.IncomeStats>();
    
    while(rs.next()){
        IncomeStats.add(new com.telzar.Data.IncomeStats(rs));
    }
